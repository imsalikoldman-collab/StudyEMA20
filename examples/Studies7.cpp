...
SCSFExport scsf_RSI(SCStudyInterfaceRef sc)
{
	...
	SCSubgraphRef Subgraph_RSIAvg = sc.Subgraph[1];
	...
	SCInputRef Input_UseRSIMinus50 = sc.Input[3];
	SCInputRef Input_Line1Value = sc.Input[4];
	SCInputRef Input_Line2Value = sc.Input[5];
	SCInputRef Input_AvgType = sc.Input[6];
...
SCSFExport scsf_RSI_W(SCStudyInterfaceRef sc)
{
	...
	SCSubgraphRef Subgraph_RSIWAvg = sc.Subgraph[1];
	SCSubgraphRef Subgraph_Line1 = sc.Subgraph[2];
	SCSubgraphRef Subgraph_Line2 = sc.Subgraph[3];
...
SCSFExport scsf_MomentumTrend(SCStudyInterfaceRef sc)
{
	...
	SCInputRef Input_Data = sc.Input[0];
	SCInputRef Input_Length = sc.Input[1];
	SCInputRef Input_MomentumType = sc.Input[2];
